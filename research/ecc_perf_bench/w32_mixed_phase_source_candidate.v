module familyrtl_ecc_ppa (double_error_o,
 ...
 sky130_fd_sc_hd__xor2_1 _107_ (.A(data_i[29]),
    .B(data_i[30]),
    .X(_089_));
 sky130_fd_sc_hd__xnor2_1 _108_ (.A(data_i[21]),
    .B(data_i[22]),
    .Y(_090_));
 ...
 sky130_fd_sc_hd__xor2_1 _117_ (.A(data_i[27]),
    .B(data_i[28]),
    .X(_099_));
 sky130_fd_sc_hd__xnor2_1 _118_ (.A(data_i[19]),
    .B(data_i[20]),
    .Y(_100_));
 ...
 sky130_fd_sc_hd__xor2_1 _124_ (.A(_103_),
    .B(_104_),
    .X(_105_));
 sky130_fd_sc_hd__xor2_1 _125_ (.A(data_i[2]),
    .B(data_i[34]),
    .X(_106_));
 ...
 sky130_fd_sc_hd__clkinv_1 _131_ (.A(_004_),
    .Y(syndrome_o[1]));
 sky130_fd_sc_hd__xor2_1 _132_ (.A(data_i[7]),
    .B(data_i[8]),
    .X(_005_));
 ...
 sky130_fd_sc_hd__xor2_1 _154_ (.A(data_i[20]),
    .B(data_i[28]),
    .X(_024_));
 sky130_fd_sc_hd__xor2_1 _155_ (.A(data_i[16]),
    .B(data_i[24]),
    .X(_025_));
 sky130_fd_sc_hd__xor2_1 _156_ (.A(_024_),
    .B(_025_),
    .X(_026_));
 sky130_fd_sc_hd__xnor2_1 _157_ (.A(data_i[32]),
    .B(data_i[0]),
    .Y(_027_));
 ...
 sky130_fd_sc_hd__xnor3_1 _165_ (.A(_032_),
    ...
    .C(_034_),
    .X(_035_));
 sky130_fd_sc_hd__xor3_1 _166_ (.A(_028_),
    .B(_029_),
    .C(_035_),
    .X(_036_));
